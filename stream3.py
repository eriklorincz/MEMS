...
#change default audio output device to jack
...
#input stream setup
stream=p.open(format = pyaudio.paInt16,rate=RATE,channels=1, input_device_index = 3, input=True, frames_per_buffer=chunk)
